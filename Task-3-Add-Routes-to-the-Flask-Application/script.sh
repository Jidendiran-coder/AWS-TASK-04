...
@app.route('/')
def home():
    return "Welcome to my Flask Application HomePage!"

@app.route('/about')
def about():
    return 'This is the About Page. This is a simple Flask application deployed on AWS EC2.'

@app.route('/contact')
def contact():
    return 'For inquiries, please contact us at contact@yourapp.com'
